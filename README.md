Este proyecto es una práctica de programación orientada a objetos (POO) en PHP, aplicando el patrón Modelo-Vista-Controlador (MVC) junto con el motor de plantillas Smarty.
